function [y] = XConv_cTFA_fa_module(x)
...
for i = 1:17
    [x_gru1(17-i+1,:), h_cache1] = GRU_module(x_t_re(i,:), nHidden, h_cache1, fa_re_ih_weight, fa_re_ih_bias, fa_re_hh_weight, fa_re_hh_bias, -13, -8);
end

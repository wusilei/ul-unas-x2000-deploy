...
#define E1_CTFA_TA_FC_QR         (-10)  /* MATLAB: 2^(-10) */
...
#define E2_CTFA_TA_FC_QR         (-10)  /* MATLAB: 2^(-10) */
...
#define E3_CTFA_TA_FC_QR         (-10)  /* MATLAB: 2^(-10) */
...
#define E4_CTFA_TA_FC_QR         (-9)   /* MATLAB: 2^(-9) */

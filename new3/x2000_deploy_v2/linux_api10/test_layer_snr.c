...
int main(int argc, char **argv) {
    ...
    printf("Input: frame0_bm.bin (%d elements)\n\n", BM_OUT_BINS);
    ...
    printf("─── Encoder ───\n");
    {
        ...
        snprintf(path, sizeof(path), "%s/frame0_e4.bin", dir);
        ...
        snprintf(path, sizeof(path), "%s/frame0_rnn1.bin", dir);
        ...
        snprintf(path, sizeof(path), "%s/frame0_rnn2.bin", dir);
        ...
        /* D0 */
        snprintf(path, sizeof(path), "%s/frame0_d0.bin", dir);
        ...
        /* D1 */
        snprintf(path, sizeof(path), "%s/frame0_d1.bin", dir);
        ...
        /* D2 */
        snprintf(path, sizeof(path), "%s/frame0_d2.bin", dir);
        ...
        /* D3 */
        snprintf(path, sizeof(path), "%s/frame0_d3.bin", dir);

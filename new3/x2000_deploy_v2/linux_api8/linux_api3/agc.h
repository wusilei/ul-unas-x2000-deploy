...
#define AGC_GOAL_HIGH  (1LL << 22)   /* 4194304 → RMS≈2048 (-24dBFS) */
#define AGC_GOAL_LOW   (1LL << 18)   /* 262144  → RMS≈512  (-36dBFS) 远场增强 */

#define AGC_GAIN_HIGH_NUM 7           /* 3.5x 固定增益 (近场) */
#define AGC_GAIN_LOW_NUM  10          /* 5.0x 固定增益 (远场, 激进) */

/**
 * fft_q15.h — Fixed-point 512-pt Radix-2 DIT FFT
 * ===============================================
 * Replaces KissFFT with pure integer arithmetic for MIPS soft-float.
 * Forward: N=512 real → 257 complex. Inverse: 257 complex → 512 real.
 */
...
static inline void fft_q15_512(int32_t *real, int32_t *imag, int inverse) {
    ...
    /* 9 stages of radix-2 butterflies */
     ...
     * Scaling is handled by synthesis window (>>24) in noise_reduction.c. */
}

/**
 * denoising_fp.h — DENOISING MATLAB→C Fixed-Point Inference
 * ======================================================
...
#ifndef DENOISING_FP_H
#define DENOISING_FP_H

#ifdef __TI_COMPILER_VERSION__
#include "cgt_compat.h"
#endif
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
...
/* ================================================================
 * LUT function declarations (defined in denoising_lut.c)
 * ================================================================ */
 ...
 * Initialization
 * ================================================================ */
void denoising_state_init(denoising_state_t *st);

/* ================================================================
 * Low-level Operator Declarations (defined in denoising_fp.c)
 * ================================================================ */
...
/* ================================================================
 * Module-Level Function Declarations (defined in denoising_modules.c)
 * ================================================================ */

/* --- Encoder --- */
void encoder_layer0_xconv(const int32_t *x, denoising_state_t *st, int32_t *y);
void encoder_layer1_xmb0(const int32_t *x, denoising_state_t *st, int32_t *y);
void encoder_layer2_xdws0(const int32_t *x, denoising_state_t *st, int32_t *y);
void encoder_layer3_xmb1(const int32_t *x, denoising_state_t *st, int32_t *y);
void encoder_layer4_xdws1(const int32_t *x, denoising_state_t *st, int32_t *y);
void encoder_module(const int32_t *x, denoising_state_t *st,
...
/* --- Decoder --- */
void decoder_layer0_de_xdws0(const int32_t *x, const int32_t *skip, denoising_state_t *st, int32_t *y);
void decoder_layer1_de_xmb0(const int32_t *x, const int32_t *skip, denoising_state_t *st, int32_t *y);
void decoder_layer2_de_xdws1(const int32_t *x, const int32_t *skip, denoising_state_t *st, int32_t *y);
void decoder_layer3_de_xmb1(const int32_t *x, const int32_t *skip, denoising_state_t *st, int32_t *y);
void decoder_layer4_de_xconv(const int32_t *x, const int32_t *skip, denoising_state_t *st, int32_t *y);
void decoder_module(const int32_t *x, denoising_state_t *st,
                    const int32_t *e0, const int32_t *e1, const int32_t *e2,
                    const int32_t *e3, const int32_t *e4,
                    int32_t *y);

/* ================================================================
 * Top-Level Inference (defined in denoising_infer.c)
 * ================================================================ */

/**
 * denoising_infer_frame: Single-frame inference
 ...
 */
void denoising_infer_frame(const float *spec_real, const float *spec_imag,
                        denoising_state_t *st, int32_t *y_mask);

#ifdef __cplusplus
}
#endif

#endif /* DENOISING_FP_H */

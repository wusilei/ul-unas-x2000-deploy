/**
 * denoising_lut.h — Fixed-Point LUT Declarations
 * ============================================
...
#ifndef DENOISING_LUT_H
#define DENOISING_LUT_H
...
/* ================================================================
 * LUT data tables (defined in denoising_lut.c)
 * ================================================================ */

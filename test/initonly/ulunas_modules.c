/**
 * denoising_modules.c — DENOISING Module Assembly
 * ===========================================
 ...
 * in denoising_matlab_weights.h and calls the corresponding operators
...
/* Forward declare all weight arrays (defined in denoising_matlab_weights.c) */
...
void encoder_layer1_xmb0(const int32_t *x, denoising_state_t *st, int32_t *y) {
    ...
    /* BN */
    int32_t y_bn[24 * 65];
    bn_func_uw(y_pconv0, encoder_en_convs_1_pconv1_1_weight, encoder_en_convs_1_pconv1_1_bias,
...
void decoder_layer1_de_xmb0(const int32_t *x, const int32_t *skip, denoising_state_t *st, int32_t *y) {
    ...
    /* BN */
    int32_t y_bn0[24 * 33];
    bn_func_uw(y_pconv0, decoder_de_convs_1_pconv1_1_weight, decoder_de_convs_1_pconv1_1_bias,
